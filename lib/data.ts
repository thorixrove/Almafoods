const dummyData = {
    categories: [
        ...
        customizations: [
            ...
            // Sides (diganti dari "side" ke "bagian" agar sesuai enum Appwrite)
            { name: "Coke", price: 30, type: "bagian" },
            { name: "Fries", price: 35, type: "bagian" },
            { name: "Garlic Bread", price: 40, type: "bagian" },
            { name: "Chicken Nuggets", price: 50, type: "bagian" },
            { name: "Iced Tea", price: 28, type: "bagian" },
            { name: "Salad", price: 33, type: "bagian" },
            { name: "Potato Wedges", price: 38, type: "bagian" },
            { name: "Mozzarella Sticks", price: 45, type: "bagian" },
            { name: "Sweet Corn", price: 25, type: "bagian" },
            { name: "Choco Lava Cake", price: 42, type: "bagian" },
        ],
